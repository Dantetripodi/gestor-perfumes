...
import { Plus, Search, ArrowDown, Package } from 'lucide-react';
              ...
              {filteredProducts.map((product) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    ...
                    >
                      <ArrowDown size={14} /> Reponer stock
                    </button>
                  </td>
                </tr>
              ))}
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    className="w-full border border-slate-200 rounded-lg p-3 text-sm focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none"
                    value={newProduct.avgCostUSD}
                    onChange={(e) =>
                      setNewProduct({
                        ...newProduct,
                        avgCostUSD: Number(e.target.value),
                      })
                    }
                  />
                </div>
